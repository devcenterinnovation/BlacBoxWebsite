...
<Stack alignItems='center' spacing={1}>
  ...
  <Button sx={{backgroundColor:'#E2C703', textTransform:'none', color:'black',fontWeight:'600', letterSpacing: '0.02em', fontSize:'16px', width: {md:'20vw', sm:'30vw', xs:'fit-content'},padding:'20px', '&:hover':{backgroundColor:'#E2C703', color:'black', textTransform:'none' }}}>Join Waitlist</Button>
