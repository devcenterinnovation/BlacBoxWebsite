...
export default function Waitlistform() {
  ...
  return (
    ...
    <Button sx={{backgroundColor:'#E2C703',textTransform:'none', color:'black',width:{md:'20vw',xs:'100%', sm:'40vw'}, padding:'20px', '&:hover':{backgroundColor:'#E2C703', color:'black' }}}>Submit</Button>
        </Stack>
        </Card>
      </Grid>
    </Grid>
